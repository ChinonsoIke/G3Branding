        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="col-md-5 col-sm-5 text-right form-group pull-right top_search">
                    <a href="{{ route('admin.users.index') }}" class="btn btn-outline-success"> <i class="fa fa-arrow-left"></i> Back To Users</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="x_content">
                        <div class="col-md-3 col-sm-3  profile_left">
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    <!-- Current avatar -->
                                    <img class="img-responsive avatar-view" src="{{ asset('admin/build/images/user.png') }}" alt="Avatar" title="Change the avatar">
                                </div>
                            </div>
                            <h3>{{ $user->getName() }}</h3>
                            ...
                            <ul class="list-unstyled user_data">
                                ...
                                <li>
                                    <p>Phone Number: </p>
                                    <span>{{ $user->phone ?? 'Not provided' }}</span><br/>
                                </li>
                            </ul>
                            <!-- end of skills -->
