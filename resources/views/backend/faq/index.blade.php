                    ...
                    <div class="x_content">
                        ...
                        <div class="tab-content" id="myTabContent">
                                                ...
                                                @forelse($faqs as $faq)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ route('admin.faqs.delete',['faq' => $faq]) }}" class="btn btn-sm btn-outline-danger">Delete <i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                            ...
                            <div class="tab-pane fade" id="add" role="tabpanel" aria-labelledby="profile-tab">
                                <form id="demo-form2" class="form-horizontal form-label-left" method="post" action="{{ route('admin.faqs.create') }}">
                                    @csrf
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="title">Question <span class="required">*</span>
                                        </label>
