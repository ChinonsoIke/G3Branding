						...
						<div class="row">
							<div class="col-xs-12 category-image visible-md visible-lg">
                                ...
                                <a href="#" title="category image">
									<img src="image/topbanner1.png" alt="Business card">
								</a>
                                @endInlineEditor
							...
							<ul>
                                ...
                                <li class="pro-item col-md-4 col-sm-6 col-xs-12">
									<div class="product-image-action">
										<img src="{{asset('uploads/products/' .$item->image)}}" width=300 height=300 alt="Grouper Business Card">
									</div>
