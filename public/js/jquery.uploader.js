        ...
        reader.onload = function(event) {
          ...
          image.onload = function() {
            ...
            */
            ...
            // Make Thumbnail
            console.log();//("inline-content-block",uploader))
            var inlineEditor =  $(".uploader-preview", uploader).parent("div").siblings("inline-content-block");
            inlineEditor.html("<img src='" + image.src + "'>")
            inlineEditor.attr("content", "<img src='" + image.src + "'>")
           // uploader.closest("inline-content-block").html("<img src='" + image.src + "'>")
